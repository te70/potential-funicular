...
var ExerciseUsers = mongoose.model('ExerciseUsers', exerciseUserSchema);
...
app.get('/api/user/:_id/exercises', function(req, res) {
...
app.use(( err, req, res, next) => {
  ...
  if(err.errors) {
    ...
    const kets = Object.keys(err.errors);
    //report the first validation error
    errMessage = err.errors[keys[0]].message;
  } else {
    //generic or custom error
    errCode = err.status || 500;
    errMessage = err.messaege || 'Internal Server Error';
  }
